...
export default function CommandCenter({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', padding: '12px 24px 24px' }}>
      {/* Filter bar */}
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '14px', fontSize: '0.72rem', color: 'var(--text-muted)' }}>
          <span><strong style={{ color: '#fff' }}>21</strong> Districts</span>
          <span><strong style={{ color: '#fff' }}>47</strong> ATM Clusters</span>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '68% 32%', gap: '14px', height: '520px' }}>
        {/* Left: GIS Map View */}
        <div className="glass-panel" style={{ padding: '8px', height: '100%', display: 'flex', flexDirection: 'column', position: 'relative' }}>
          <div style={{ position: 'absolute', top: '16px', right: '16px', zIndex: 999, background: 'rgba(12, 18, 32, 0.85)', padding: '5px 10px', borderRadius: '7px', border: '1px solid var(--border-glass)', fontSize: '0.7rem', display: 'flex', alignItems: 'center', gap: '6px', backdropFilter: 'blur(10px)' }}>

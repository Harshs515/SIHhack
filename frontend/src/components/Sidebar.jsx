...
export default function Sidebar() {
  return (
    ...
    >
      <div style={{ padding: '6px 10px 10px 10px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <span style={{ fontSize: '0.68rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-muted)' }}>
          INTELLIGENCE SUITE
        </span>
        <span style={{ fontSize: '0.65rem', color: '#00e676', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '4px' }}>
          ...
          return (
            <NavLink
              ...
              style={({ isActive }) => ({
                ...
                background: isActive ? 'linear-gradient(90deg, rgba(0, 229, 255, 0.16) 0%, rgba(59, 130, 246, 0.08) 100%)' : 'transparent',
                border: isActive ? '1px solid rgba(0, 229, 255, 0.4)' : '1px solid transparent',
                boxShadow: isActive ? '0 4px 16px rgba(0, 229, 255, 0.15)' : 'none',
                ...
                <>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 }}>
                    ...
                    <div style={{ minWidth: 0 }}>
                      <div style={{ fontSize: '0.82rem', fontWeight: isActive ? 800 : 600, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', color: isActive ? '#fff' : 'var(--text-main)' }}>
                        {item.label}
                      </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
          ...
          <span style={{ color: '#00e676', fontWeight: 700, fontSize: '0.66rem' }}>SYNCHRONIZED</span>
        </div>
